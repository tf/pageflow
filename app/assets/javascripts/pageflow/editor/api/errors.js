...
pageflow.NestedTypeError = pageflow.UploadError.extend({
  ...
  initialize: function(upload, options) {
    ...
    var validParentFileTypes = _.filter(fileTypes.fileTypes.fileTypes, function(parentFileType) {
      return _.contains(parentFileType.nestedFileTypes.fileTypes, fileType);
    });
