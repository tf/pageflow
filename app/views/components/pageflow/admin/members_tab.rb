        ...
        if Pageflow.config.invitation_workflows
          embedded_index_table(entry.invitations.includes(:user).references(:users),
                               blank_slate_text: I18n
                                 .t('pageflow.admin.entries.no_invited_users')) do
            table_for_collection class: 'invitations', sortable: true, i18n: Pageflow::Invitation do
              column :user,
                     sortable: 'pageflow_invitations.last_name',
                     class: 'name' do |invitation|
              ...
              column :role,
                     ...
                     title: I18n
                       .t('activerecord.attributes.pageflow/membership.role') do |invitation|
