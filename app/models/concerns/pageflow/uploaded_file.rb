module Pageflow
  module UploadedFile
    ...
    included do
      ...
      belongs_to :entry
      belongs_to :parent_file, polymorphic: true
    ...
    def parent_allows_type_for_nesting
      if parent_file.present?
        parent_class = parent_file_type.constantize
    ...
    def parent_nested_file_types
      Pageflow.config.file_types.find_by_model!(parent_file_type.constantize).nested_file_types
    end
  end
end
