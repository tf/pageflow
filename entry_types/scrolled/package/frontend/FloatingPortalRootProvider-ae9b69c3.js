...
import { _ as _slicedToArray, a as _objectSpread2, b as _defineProperty, u as useI18n, c as useEntryMetadata, d as useNestedFiles, e as _objectWithoutProperties, f as useWidget, g as useTheme, h as useContentElement, i as useFileWithInlineRights, j as useFile, k as useSectionForegroundContentElements, l as useAdditionalSeedData, m as useSectionsWithChapter, n as useContentElementConsentVendor, T as ThemeIcon, o as _toConsumableArray, E as EntryStateProvider, L as LocaleProvider, p as useChapter, q as useEntryStateDispatch, r as useSection } from './ThemeIcon-b446adeb.js';
import classNames from 'classnames';
import { u as useDelayedBoolean, a as useContentElementEditorState } from './useContentElementEditorState-783e3ca4.js';
...
import { u as useBrowserFeature, P as PhonePlatformContext, B as BrowserFeaturesProvider } from './PhonePlatformContext-71c3caf1.js';
...
function importComponents() {
  return import('./components-714622a8.js');
}
...
function RestrictWidth(_ref) {
  ...
  if (width >= 0) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: styles$a["restrict-".concat(widthName(width))]
    }, children);
  }
}
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(ContentElements, {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: classNames(styles$b.item, styles$b["item-".concat(position, "-").concat(width)])
      }, props.children( /*#__PURE__*/React.createElement("div", {
        className: classNames(styles$b["inner-".concat(item.position)], styles$b["inner-".concat(width)], _defineProperty({}, styles$b["sideBySide"], sideBySideFloat(props.items, index)))
...
var styles$f = {"effects":"Effects-module_effects__2swN4","autoZoom":"Effects-module_autoZoom__109yr"};
...
function Effects(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: ref,
    className: classNames(styles$f.effects, _defineProperty({}, styles$f.autoZoom, autoZoomRunning)),
...
var styles$g = {"fill":"Image-module_fill__1D1wH","contain":"Image-module_contain__3_XWB"};
...
function renderImageTag(props, imageFile) {
  ...
  return /*#__PURE__*/React.createElement("img", {
    className: classNames(_defineProperty(_defineProperty({}, styles$g.fill, props.fill), styles$g.contain, props.fit === 'contain')),
...
var styles$h = {"Backdrop":"Backdrop-module_Backdrop__1w4UZ","noCompositionLayer":"Backdrop-module_noCompositionLayer__33IlH","coverSection":"Backdrop-module_coverSection__201GK","defaultBackground":"Backdrop-module_defaultBackground__1YQQL"};

var sharedTransitionStyles = {"fixed":"shared-module_fixed__3T2AK","justifyBottom":"shared-module_justifyBottom__22ncu"};
...
var Backdrop = withInlineEditingDecorator('BackdropDecorator', function Backdrop(props) {
  ...
  var _useSectionLifecycle = useSectionLifecycle(),
    shouldLoad = _useSectionLifecycle.shouldLoad;
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(styles$h.Backdrop, _defineProperty({}, styles$h.noCompositionLayer, !shouldLoad && !props.eagerLoad), _defineProperty({}, styles$h.coverSection, props.size === 'coverSection'), props.transitionStyles.backdrop, props.transitionStyles["backdrop-".concat(props.state)])
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: classNames(styles$h.defaultBackground, props.transitionStyles.backdropInner2)
...
var styles$i = {"wrapper":"Positioner-module_wrapper__3iFSg"};
...
var styles$j = {"root":"Picture-module_root__1BCCg"};
...
var styles$k = {"effects":"Effects-module_effects__MDZRR"};
...
function Backdrop$1(props) {
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(styles$h.Backdrop, props.transitionStyles.backdrop, props.transitionStyles["backdrop-".concat(props.state)])
  }, /*#__PURE__*/React.createElement("div", {
...
var styles$l = {"section":"Section-module_section__7UvMm","orientation":"Section-module_orientation__3-m2N","exposeMotifArea":"Section-module_exposeMotifArea__2rsq_","layout-left":"Section-module_layout-left__2IqOD","layout-right":"Section-module_layout-right__3al0b"};
...
function useBackdropSectionClassNames$1(backdrop) {
  ...
  return [styles$l.section, !fullscreenDimensions.height && styles$l.orientation, styles$l["layout-".concat(layout || 'left')], exposeMotifArea && !empty && styles$l.exposeMotifArea, useAspectRatioClassName(backdrop.file, fullscreenDimensions), useAspectRatioClassName(backdrop.mobileFile, fullscreenDimensions, {
    mobile: true
  })].filter(Boolean);
}
...
var fadeInBgFadeOut = {"fade-duration":"0.5s","backdrop":"fadeInBgFadeOut-module_backdrop__r0YXp","backdropInner":"fadeInBgFadeOut-module_backdropInner__IQp87 shared-module_fixed__3T2AK","backdrop-below":"fadeInBgFadeOut-module_backdrop-below__2G-Ic","foreground":"fadeInBgFadeOut-module_foreground__Q2vkT","foreground-above":"fadeInBgFadeOut-module_foreground-above__3pmz9"};
...
function GradientShadow(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(styles$o["align-".concat(props.align)], props.inverted ? styles$o.light : styles$o.dark)
  }, /*#__PURE__*/React.createElement("div", {
    className: styles$o.dynamic,
    style: {
...
var styles$p = {"start":"InvisibleBoxWrapper-module_start__F1nZ7","end":"InvisibleBoxWrapper-module_end__nphD-"};
...
function InvisibleBoxWrapper(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(_defineProperty(_defineProperty({}, styles$p.start, !openStart && !full), styles$p.end, !openEnd && !full))
  }, children);
}

var styles$q = {"wrapper":"GradientBox-module_wrapper__1Jj7N","content":"GradientBox-module_content__96lDk","shadow":"GradientBox-module_shadow__2XilX","gradient":"GradientBox-module_gradient__31tJ-","long":"GradientBox-module_long__10s6v","root":"GradientBox-module_root__8Xn9W","withShadow":"GradientBox-module_withShadow__3mhPR","shadowDark":"GradientBox-module_shadowDark__3Tv0L","shadowLight":"GradientBox-module_shadowLight__Bieg6"};

function GradientBox(props) {
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(styles$q.root, _defineProperty(_defineProperty({}, styles$q.gradient, props.motifAreaState.isContentPadded), styles$q["long"], props.coverInvisibleNextSection)),
    style: {
    ...
    className: classNames(styles$q.shadow, props.inverted ? styles$q.shadowLight : styles$q.shadowDark, props.transitionStyles.boxShadow, props.transitionStyles["boxShadow-".concat(props.state)]),
    style: {
...
var styles$r = {"content":"CardBox-module_content__36v7J","wrapper":"CardBox-module_wrapper__3vnaH"};
...
function className$1(props) {
  return classNames(styles$s.card, props.inverted ? styles$s.cardBgBlack : styles$s.cardBgWhite, styles$s["selfClear-".concat(props.selfClear)], _defineProperty({}, styles$s.blur, props.cardSurfaceTransparency > 0), _defineProperty({}, styles$s.cardStart, !props.openStart), _defineProperty({}, styles$s.cardEnd, !props.openEnd));
}
...
var Section = withInlineEditingDecorator('SectionDecorator', function Section(_ref) {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    ref: ref,
    className: classNames(styles$m.Section, transitionStyles.section, backdropSectionClassNames, _defineProperty({}, styles$m.first, section.sectionIndex === 0), _defineProperty({}, styles$m.narrow, section.width === 'narrow'), section.invert ? styles$m.darkContent : styles$m.lightContent),
...
var styles$t = {"focusOutlineDisabled":"focusOutline-module_focusOutlineDisabled__KV7d-"};
...
function FocusOutlineProvider(_ref) {
  ...
  useEffect(function () {
    ...
    function enable() {
      document.body.classList.remove(styles$t.focusOutlineDisabled);
      setValue(true);
    }
    function disable() {
      document.body.classList.add(styles$t.focusOutlineDisabled);
      setValue(false);
    }
  }, []);
...
var styles$u = {"optIn":"OptIn-module_optIn__3nHo1","optInIcon":"OptIn-module_optInIcon__3-81I","optInMessage":"OptIn-module_optInMessage__1OfTR","optInButton":"OptIn-module_optInButton__1LhtX"};
...
var styles$v = {"optOut":"OptOutInfo-module_optOut__2Q3d5","tooltip":"OptOutInfo-module_tooltip__2bpU0","icon":"OptOutInfo-module_icon__1kL6Q utils-module_unstyledButton__3rgne","full":"OptOutInfo-module_full__s_Ono"};
...
function OptOutInfo(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(styles$v.optOut, _defineProperty({}, styles$v.full, width === widths.full || inset)),
    style: hide ? {
      opacity: 0,
      visibility: 'hidden'
    } : undefined
...
var EditableText = withInlineEditingAlternative('EditableText', function EditableText(_ref) {
  var value = _ref.value,
    ...
    typographySize = _ref.typographySize;
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(styles$w.root, className)
...
function renderElement(_ref2) {
  ...
  var className = classNames(variantClassName, sizeClassName, _defineProperty({}, styles$w.justify, element.textAlign === 'justify'));
...
function Heading(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("h2", Object.assign({}, attributes, {
    className: classNames(className, darkBackground ? styles$w.light : styles$w.dark, 'scope-headings', textStyles['heading-xs']),
    style: inlineStyles
  }), children);
}
...
var styles$x = {"crop":"SectionThumbnail-module_crop__Q1nZj","scale":"SectionThumbnail-module_scale__2tKDG"};
  ...
  if (section) {
    return /*#__PURE__*/React.createElement(StaticPreview, null, /*#__PURE__*/React.createElement(Measure, {
      ...
      return /*#__PURE__*/React.createElement(FullscreenDimensionProvider, clientDimensions(contentRect, scaleFactor), /*#__PURE__*/React.createElement("div", {
        ref: measureRef,
        className: styles$x.crop,
        inert: ""
      }, /*#__PURE__*/React.createElement("div", {
        className: classNames(_defineProperty({}, styles$x.scale, scale))
      }, /*#__PURE__*/React.createElement("div", {
...
var styles$y = {"table":"EditableTable-module_table__uncog"};
...
var EditableTable = withInlineEditingAlternative('EditableTable', function EditableTable(_ref) {
  ...
  return /*#__PURE__*/React.createElement("table", {
    className: classNames(className, styles$y.table)
...
export { FloatingPortalRootProvider as $, AtmoProvider as A, useBackgroundFile as B, ConnectedSection as C, ContentElementAttributesProvider as D, EventContextDataProvider as E, Fullscreen as F, useContentElementEditorCommandSubscription as G, ContentElementEditorCommandEmitterContext as H, InlineFileRights as I, useContentElementLifecycle as J, ContentElementLifecycleContext as K, Link as L, useCurrentChapter as M, useIsStaticPreview as N, useOnUnmuteMedia as O, PlayerEventContextDataProvider as P, usePortraitOrientation as Q, RootProviders as R, SelectableWidget as S, Text as T, EditableTable as U, OptIn as V, Widget as W, OptOutInfo as X, useConsentRequested as Y, useFloatingPortalRoot as Z, _asyncToGenerator as _, useCurrentSectionIndexState as a, getTransitionNames as a0, getAvailableTransitionNames as a1, paletteColor as a2, widthName as a3, Image as a4, MediaPlayer as a5, getInitialPlayerState as a6, playerStateReducer as a7, usePlayerState as a8, VideoPlayer as a9, AudioPlayer as aa, processSources as ab, Atmo as ac, AtmoContext as ad, useAtmo as ae, OnScreenObserverRootProvider as af, useOnScreen as ag, StandaloneSectionThumbnail as ah, SectionThumbnail as ai, MotifAreaVisibilityProvider as aj, ForcePaddingContext as ak, ContentElementConfigurationUpdateContext as al, LayoutWithoutInlineEditing as am, renderElement as an, renderLeaf as ao, createRenderElement as ap, useScrollToTarget as b, usePostMessageListener as c, contentStyles as d, withInlineEditingAlternative as e, useDarkBackground as f, getEventObject as g, EditableText as h, isBlankEditableTextValue as i, useContentElementAttributes as j, widths as k, useContentElementConfigurationUpdate as l, useTextTracks as m, useMediaMuted as n, useFocusOutlineVisible as o, useVideoQualitySetting as p, useIsomorphicLayoutEffect as q, frontendStyles as r, utils as s, styles$q as t, usePrevious as u, registerVendors as v, withInlineEditingDecorator as w, api as x, loadInlineEditingComponents as y, useAudioFocus as z };
