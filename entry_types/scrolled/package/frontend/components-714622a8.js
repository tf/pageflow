import { H as ContentElementEditorCommandEmitterContext, c as usePostMessageListener, aj as MotifAreaVisibilityProvider, ak as ForcePaddingContext, al as ContentElementConfigurationUpdateContext, x as api, k as widths, am as LayoutWithoutInlineEditing, Z as useFloatingPortalRoot, ai as SectionThumbnail, an as renderElement, ao as renderLeaf$1, G as useContentElementEditorCommandSubscription, T as Text$1, r as frontendStyles, ap as createRenderElement, b as useScrollToTarget } from './FloatingPortalRootProvider-ae9b69c3.js';
import 'pageflow/frontend';
import React, { useMemo, useState, useCallback, useContext, useRef, useEffect, createContext, memo } from 'react';
import { _ as _slicedToArray, q as useEntryStateDispatch, b as _defineProperty, e as _objectWithoutProperties, u as useI18n, J as updateContentElementConfiguration, p as useChapter, j as useFile, a as _objectSpread2, o as _toConsumableArray, K as _unsupportedIterableToArray } from './ThemeIcon-b446adeb.js';
import classNames from 'classnames';
import { C as ContentElementEditorStateContext, a as useContentElementEditorState } from './useContentElementEditorState-783e3ca4.js';
...
import { P as PhonePlatformContext } from './PhonePlatformContext-71c3caf1.js';
...
function handleTableNavigation(editor, event) {
  var selection = editor.selection;
  if (selection && Range.isCollapsed(selection)) {
    var cellMatch = Cell.match(editor);
    if (cellMatch) {
...
var EditableTable = React.memo(function EditableTable(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Slate, {
    ...
    className: classNames(className, _defineProperty({}, selectedClassName, isSelected))
  }, /*#__PURE__*/React.createElement(Editable, {
    as: "tbody",
    decorate: decorateLineBreaks,
    onKeyDown: handleKeyDown,
...
var styles$e = {"reference":"ActionButton-module_reference__1W3Kz","button":"ActionButton-module_button__8gy6J","floating":"ActionButton-module_floating__2FUpI","escaped":"ActionButton-module_escaped__MrcQb","size-lg":"ActionButton-module_size-lg__HhcLX","position-outside":"ActionButton-module_position-outside__1E_lp","position-outsideLeft":"ActionButton-module_position-outsideLeft__3BvpT","position-outsideIndented":"ActionButton-module_position-outsideIndented__3vf-7","position-inside":"ActionButton-module_position-inside__28_gp","position-center":"ActionButton-module_position-center__1KDoh"};
...
function ActionButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    className: classNames(styles$e.button, styles$e["size-".concat(size)]),
    onClick: onClick
  }, /*#__PURE__*/React.createElement(Icon, {
    width: iconSize,
    height: iconSize
...
function EditableLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    openInNewTab: openInNewTab,
    className: className
  }, children)), actionButtonVisible && /*#__PURE__*/React.createElement(ActionButton, {
