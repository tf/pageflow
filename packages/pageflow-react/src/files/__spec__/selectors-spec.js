...
describe('file', () => {
  ...
  test('selects null if id is unknown', () => {
  ...
  test('includes parent file info', () => {
  ...
  test('sets modelType from mapping', () => {
    const files = {'video_files': [{id: 5, perma_id: 50, variants: ['high']}]};
  ...
  test('interpolates id partition into file url template', () => {
  ...
  test('interpolates basename into file url template', () => {
  ...
  test('skips url with missing template', () => {
  ...
  test('includes urls for all templates if variants is undefined', () => {
...
describe('nestedFiles', () => {
  test('selects nested files of given parent', () => {
    const files = {
  ...
  test('filters out unsaved files', () => {
    const files = {
      'video_files': [{id: 2004, perma_id: 31, variants: ['unknown']}],
      'text_track_files': [
        {
  ...
  test('selects empty array if parent is undefined', () => {
    const files = {
      'video_files': [{id: 2004, perma_id: 31, variants: ['unknown']}],
      'text_track_files': [
        {
...
describe('fileExists', () => {
  test('returns function to check if given file exists', () => {
    const files = {
