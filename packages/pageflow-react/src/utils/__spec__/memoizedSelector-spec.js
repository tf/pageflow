...
describe('memoizedSelector', () => {
  describe('unwrap', () => {
    test('turns memoizedSelector into selector', () => {
    ...
    test('returns selector that memoizes return value for same arguments', () => {
      let counter = 0;
      const selectorCreator = memoizedSelector(
        state => state.value,
        function(value) {
    ...
    test('returns selectors that memoize individually on subsequent calls', () => {
      let counter = 0;
      const selectorCreator = memoizedSelector(
        state => state.value,
        function(value) {
    ...
    test('returns non memoized selector unaltered', () => {
  ...
  describe('when with state', () => {
    test('works like a normal selector', () => {
  ...
  test('allows memoized selectors as input selectors', () => {
  ...
  describe('combine', () => {
    ...
    test('supports combining non memoized selectors', () => {
