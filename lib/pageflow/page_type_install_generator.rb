module Pageflow
  class PageTypeInstallGenerator < Rails::Generators::Base
    ...
    def require_assets
      ...
      append_asset_import_to('pageflow/application.css.scss', "pageflow/#{engine_name_suffix}")
      append_asset_import_to('pageflow/editor.css.scss', "pageflow/#{engine_name_suffix}/editor")
    end
    ...
    def engine_file?(*path)
      File.exists?(engine.root.join(*path))
    end
